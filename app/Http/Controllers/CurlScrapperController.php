...
/**
*Class that does scraping from https://www.zomato.com for the restaurants using regular *expressions
*It also returns the view.
*/
class CurlScrapperController extends Controller
{
	/*
	*Function that performs scraping using regular expression and returns the view.
	*/
