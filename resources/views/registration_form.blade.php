	...
	<form action="" method="post" enctype="multipart/form-data" name="myform">
		...
		<div class="row">
			...
			<div class="col-sm-4 form-group">
				...
				<input class="form-control" type="password" name="retypepassword" maxlength= 6 id="retypepassword" onchange="pwd()"  placeholder="RETYPE PASSWORD Here.." ><p id="id24"></p>
			 	...
			 	<div class="alert alert-danger" type="hidden"><span class="glyphicon glyphicon-exclamation-sign">{!!$errors->first('retypepassword')!!} </div></span>
			 	@endif
		...
		<div class="row">
			...
			<div class="col-sm-4 form-group">
				...
				<input class="form-control" type="text" name="mname" maxlength=10 placeholder="Enter middle name Here.." id="mname" onchange="myname('id3','mname')" value="{{ old('mname') }}">
				<p id="id3"></p>
		...
		<div class="row">
			...
			<div class="col-sm-6 form-group">
				...
				<input class="form-control" type="email" maxlength=50 placeholder="Enter EMAIL ID Here.." name="email" id="email" onchange="email('id19','emailid')"  value="{{ old('email') }}"><p id="id19"></p>
